...
from lib.UDCNet_PVT import Network
...
if __name__ == '__main__':
    ...
    parser.add_argument('--decay_epoch', type=int, default=, help='every n epochs decay learning rate')#80
    ...
    # build the model
    device_ids = [0,1,2,4] # if you want to use more gpus than 2, you shoule change it just like when use opt.gpu_id='1,2,6,8' , device_ids = [0,1,2,3]
    ...
    train_loader = get_loader(image_root=opt.train_root + 'images/',
                              ...
                              edge_root=opt.train_root + '/edge/' + 'edge/',
