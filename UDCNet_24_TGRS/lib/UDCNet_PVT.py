...
class Network(nn.Module):
    ...
    def __init__(self, channels=128):
        ...
        self.FSDT5 = Module1_res(512, channels)
        self.FSDT4 = Module1_res(320+channels, channels)
        self.FSDT3 = Module1_res(128+channels, channels)
        self.FSDT2 = Module1_res(64+channels, channels)

        self.DSE = DSE_module(512 + channels, channels)
    ...
    def forward(self, x):
        ...
        p1 = self.DSE(torch.cat((x4_1,x4_2),1))
        x5_4 = p1
